...
For non-host roles, the `CONFIG` object declares `messages`.
...
A session object represents a connection established from a non-host role to the host. Sessions provide a small, explicit lifecycle surface:
