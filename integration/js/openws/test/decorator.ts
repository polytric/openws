...
await session1.handleMessage('client', 'sendMessage', { userId: '1', roomId: '1', text: 'Hello' })
await session2.handleMessage('client', 'sendMessage', { userId: '2', roomId: '1', text: 'Hello' })

const session3 = runtime.newSession(async (fromRole: string, messageName: string, payload: any) => {
